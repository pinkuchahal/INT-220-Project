        ...
        <div class="row">
                    ...
                    <div class="col">
                        <?php
                            if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                                ...
                                echo '<button type="submit" name="top_sale_submit" class="btn btn-primary font-size-16 form-control">Add to Cart</button>';
                            }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                    ...
                    <div class="d-flex">
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-retweet border p-2 rounded-pill color-second-bg"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">10 Days <br> Replacement</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-truck  border p-2 rounded-pill color-second-bg"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">Daily Tuition <br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-check-double border p-2 rounded-pill color-second-bg"></span>
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                <h6 class="font-baloo p-2">Color:</h6>
                    ...
                    <div class="col-6">
                        <!-- product qty section -->
                        <div class="qty d-flex p-4">
                            <h6 class="font-baloo">Qty</h6>
                            <div class="px-4 d-flex font-rale">
                                <!-- <button class="qty-up border bg-light" data-id="pro1"><i
                                        class="fas fa-angle-up"></i></button>
                                <input type="text" data-id="pro1" class="qty_input border px-2 w-25 bg-light"
                                ...
                                <button class="qty-up border bg-light" data-id="<?php echo $item['item_id'] ?? '0'; ?>"><i
                                        class="fas fa-angle-up"></i></button>
                                <input type="text" data-id="<?php echo $item['item_id'] ?? '0'; ?>" class="qty_input border px-2 w-25 bg-light"
                                    disabled value="1" placeholder="1">
